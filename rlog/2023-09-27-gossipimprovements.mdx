...
as in the case of Ethereum Improvement Proposal EIP-4844.
...
Authors in [[3](https://www.academia.edu/download/49675184/Epidemic_Information_Dissemination_in_Di20161017-472-19tykoc.pdf)] suggest only a logarithmic increase in $D$ to maintain a manageable workload for peers.
...
It is discussed in GOAL1 that overlay mesh results in better performance if $D_{avg} \approx \ln(N) + C$. 
...
1. Every node computes its available bandwidth and selects a node degree $D_i$ proportional to its available bandwidth [[4](https://inria.hal.science/tel-02375909/document)].
...
A better alternative to simple redundant transmission is to use message encoding [[9](https://ieeexplore.ieee.org/abstract/document/8737576),[10](https://dl.acm.org/doi/abs/10.1145/1993636.1993676),[11](https://ieeexplore.ieee.org/abstract/document/4276446)] for the GossipSub protocol. 
...
[3] E. Patrick et al., “Epidemic information dissemination in distributed
systems,” IEEE Computer, vol. 37, no. 5, 2004.  Retrieved from https://www.academia.edu/download/49675184/Epidemic_Information_Dissemination_in_Di20161017-472-19tykoc.pdf
