...
At the same time, bandwidth preservation (through network codind, caching at strategic locations, metadata sharing, pull-based operation, etc.) can help minimize latency.
