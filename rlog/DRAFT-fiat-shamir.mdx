...
the Fiat-Shamir heuristic is not limited to restricted to $\Sigma$-protocol.
...
Block et al. [15](https://eprint.iacr.org/2023/1071) provide the first formal analysis of Fiat-Shamir heuristic in zk-SNARKs.
...
Commonly used hash functions include [SHA-256](https://www.cs.princeton.edu/~appel/papers/verif-sha.pdf), [Keccak](https://keccak.team/keccak_specs_summary.html), and [Poseidon](https://eprint.iacr.org/2019/458).
...
- 12. [Verification of a Cryptographic Primitive: SHA-256](https://www.cs.princeton.edu/~appel/papers/verif-sha.pdf)
- 13. [Keccak specifications summary](https://keccak.team/keccak_specs_summary.html)
- 14. [Poseidon: A New Hash Function for Zero-Knowledge Proof Systems](https://eprint.iacr.org/2019/458)
- 15. [Fiat-Shamir Security of FRI and Related SNARKs](https://eprint.iacr.org/2023/1071)