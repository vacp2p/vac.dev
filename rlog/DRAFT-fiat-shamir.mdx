...
Note that the elements that would be omitted in the hash by applying weak Fiat-Shamir are $g$ and $X$.
Next, we examine a couple variations of applying weak Fiat-Shamir.
