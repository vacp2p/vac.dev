...
However, this approach may compromise the publisher's anonymity and may reveal information about the publisher and its mesh members. 
...
It is essential to mention that sending and processing of PREAMBLE/IMRECEIVING messages is optional. 
This flexibility allows for the use of custom safety strategies in various implementations. 
For example, the ongoing nim-libp2p implementation of GossipSub v1.4 allows peers to ignore PREAMBLEs 
unless they come from mesh members with higher data rates 
