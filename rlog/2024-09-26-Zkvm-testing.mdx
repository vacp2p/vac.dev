...
PLease note taht we chose not to use hardware acceleration in our benchmarks, as our project is aimed at a broad audience. 
For instance, we cannot assume AVX512 support by default, as it is typically available only in high-end CPUs.
