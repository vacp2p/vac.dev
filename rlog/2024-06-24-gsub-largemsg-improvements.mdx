...
This matter has been extensively discussed in the libp2p community [[3](https://github.com/libp2p/rust-libp2p/pull/3666),[4](https://github.com/sigp/lighthouse/pull/4383),[5](https://hackmd.io/X1DoBHtYTtuGqYg0qK4zJw),[6](https://github.com/status-im/nim-libp2p/issues/850),[7](https://github.com/vacp2p/nim-libp2p/pull/911),[8](https://github.com/vacp2p/nim-libp2p/issues/859)], 
and numerous improvements have been considered (or even incorporated) for the GossipSub protocol to enable efficient large-message propagation [[3](https://github.com/libp2p/rust-libp2p/pull/3666),[7](https://github.com/vacp2p/nim-libp2p/pull/911),[9](https://hackmd.io/@gRwfloEASH6NWWS_KJxFGQ/B18wdnNDh),[10](https://github.com/libp2p/specs/blob/master/pubsub/gossipsub/gossipsub-v1.2.md?plain=1#L52)].
...
This rise is because TCP congestion avoidance limits the maximum in-flight bytes to approximately ${C_{wnd} \times MSS}$ in a single round trip time (RTT), 
...
placing a slow peer (also in cases where many senders simultaneously select a fast peer) at the head of the transmission queue 
...
#### a. IDONTWANT Message
An IDONTWANT message, a key component of GossipSub (v1.2) [[10](https://github.com/libp2p/specs/blob/master/pubsub/gossipsub/gossipsub-v1.2.md?plain=1#L52)], can significantly reduce redundant transmissions. 
...
urging all mesh peers to hold off on sending the same message [[15](https://forum.vac.dev/t/large-message-handling-idontwant-imreceiving/281),[16](https://forum.vac.dev/t/idontwant-message-impact/283)]. 
...
4) A large message transmission can yield high $C_{wnd}$; preferring such peers during graft can be helpful.
