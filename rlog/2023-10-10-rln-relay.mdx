...
The leaf hashes are also referred to as commitments of the respecitve users.
They actual proof is done by a [Merkle Inclusion Proof](https://ethereum.org/en/developers/tutorials/merkle-proofs-for-offline-data-integrity/), which is a type of ZK proof.
...
4. Hashing algorithm: [`Poseidon`](https://eprint.iacr.org/2019/458.pdf)
