...
The second piece of information is proved with a simple range check,
along with a mechanism that can be used to interpolate the secret of a user that offends this "rate limit".
