...
The high-level idea of the economic spam protection is shown in Figure 1.
...
# Acknowledgement
Special thanks to the RLN team for their development which greatly helped in resolving zkSNARKs performance blockers. Thanks to Onur Kılıç for his explanation and pointers and for assisting with development and runtime issues. Also thanks to Barry Whitehat for his time and insightful comments.
# References
