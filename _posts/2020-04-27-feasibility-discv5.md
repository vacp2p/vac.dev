...
The discovery method currently used by [Status](https://status.im), is made up of various components and grew over time to solve a mix of problems. We want to find a simplify this while maintaining some of the properties we currently have.
