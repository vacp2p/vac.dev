...
there is the *Proof of Work* technique deployed by Whisper[^9] and *Peer scoring* method (namely reputation-based approach) adopted by LibP2P, but each of these solutions has its own shortcomings for real-life use-cases. 
