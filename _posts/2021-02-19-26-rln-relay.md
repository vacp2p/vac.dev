...
<!-- TODO I'd add a paragraph here with "Context" that briefly summarizes previous post and all the improvements that have been made on blockers since then. Proof time etc. This gives a sense of continuity -->
...
<!-- TODO Maybe brief intro "We've come a long way since a year ago, blockers resolved, now we have implemented it e2e and learned a lot, identified more issues etc etc. Still some issues blocking getting to production..."-->
...
# References
<!-- TODO Missing previous RLN vac.dev post / blockers there https://vac.dev/feasibility-semaphore-rate-limiting-zksnarks -->
...
[^15]: zkSNARKs: https://hongchao.me/zksnark/
