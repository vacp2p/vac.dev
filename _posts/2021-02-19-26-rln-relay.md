...
There are two techniques namely, *Proof of Work*  deployed by Whisper[^9] and *Peer scoring* method (namely reputation-based approach) adopted by LibP2P. However, each of these solutions has its own shortcomings for real-life use-cases as explained below. 
